...
load(input_file_path1) # dists500Converge3Bins500SamplesV2.rdata
...
load(input_file_path2) # dists500Converge3Bins1000SamplesV2.rdata
allDists_1000Samples <- allDist

load(input_file_path3) # dists500Converge3Bins5000SamplesV2.rdata
allDists_5000Samples <- allDist

load(input_file_path4) # dists500Converge3Bins10000SamplesV2.rdata
...
load(input_file_path5) # dists500Converge2Bins500SamplesV2.rdata
allDists_2Bins <- allDist

load(input_file_path1) # dists500Converge3Bins500SamplesV2.rdata
allDists_3Bins <- allDist

load(input_file_path6) # dists500Converge4Bins500SamplesV2.rdata
...
#load in data for varying distributions - dists500Converge3Bins500SamplesV2
load(input_file_path1) # dists500Converge3Bins500SamplesV2.rdata
...
ggsave("Figure_8.png", plot = output_plot, height = 2200,  width = 3000, units = "px")